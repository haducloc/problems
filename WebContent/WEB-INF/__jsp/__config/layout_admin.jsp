...
<%@ taglib prefix="t2" uri="http://algdb.appslandia.com/jstl/tags"%>
<!doctype html>
...
<body>
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm fixed-top">
      <div class="container">
        <t:actionLink clazz="navbar-brand" action="index" controller="problem">${ctx.escCt('app.name')}</t:actionLink>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <t:c t="ul" clazz="navbar-nav ml-auto" render="${not empty @(principalPath)}">
            <t2:navItem clazz="nav-item mr-3" action="index" controller="problem" linkKey="problem_index.label" />
            <t2:navItem clazz="nav-item mr-3" action="edit" controller="problem" linkKey="problem_edit.label" />
            <t2:navItem clazz="nav-item" action="index" controller="manage-pretags" linkKey="manage_pretags_index.label" />
