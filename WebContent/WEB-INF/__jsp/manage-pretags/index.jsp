...
<!-- @variables
  page.title=${ctx.esc('manage_pretags_index.page_title')}
      ...
      <div class="mb-4 p-4 border">
        ...
        <t:form id="form1" action="index" autocomplete="off">
          ...
          <div class="form-group">
            <t:fieldLabel field="tags" labelKey="preTags.tags" />
            <t:textArea path="model.tags" clazz="form-control" fmt="PreTags" rows="16" style="line-height: 2rem;" />
          </div>
